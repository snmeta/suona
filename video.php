					...
					for($i;$i<count($result);){
						...
						for($j=0;$j<5;$j++){
							...
							?>
								...
								<td>
									<center><image height="100" width="100" src="<?php echo getfield($one['thumbnail']);?>"/></center>
									<p><b><a target="_blank" href="<?php echo getfield($one['URL']);?>"><?php echo "<center>".getfield($one['video_caption'])."</center>";?></a></b></p>
									<p><?php 

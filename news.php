...
<button class="am-topbar-btn am-topbar-toggle am-btn am-btn-sm am-btn-success am-show-sm-only blog-button" data-am-collapse="{target: '#blog-collapse'}" ><span class="am-sr-only">导航切换</span> <span class="am-icon-bars"></span></button>
  <div class="am-collapse am-topbar-collapse" id="blog-collapse">
    <ul class="am-nav am-nav-pills am-topbar-nav" style="font-size:15px">
      ...
      <li class="am-active"><a href="lw-index.html">唢呐新闻</a></li>
      <li>
...
<div class="w1000 auto ovh">
	...
	<!--搜索框-->
	<form class="am-topbar-form am-topbar-right am-form-inline" role="search" action="news.php" method="post">
      <div class="am-form-group">  
        <input type="text" class="am-form-field am-input-sm" name="keywords" placeholder="请输入需要搜索的新闻"></input>
	...
	if (isset($_GET['keywords'])){
		...
		$keywords = empty($_POST['keywords']) ? "news:*":"news:".$_POST['keywords'];
	}
	//获取当前页数

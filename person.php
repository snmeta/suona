...
<button class="am-topbar-btn am-topbar-toggle am-btn am-btn-sm am-btn-success am-show-sm-only blog-button" data-am-collapse="{target: '#blog-collapse'}" ><span class="am-sr-only">导航切换</span> <span class="am-icon-bars"></span></button>
  <div class="am-collapse am-topbar-collapse" id="blog-collapse">
    <ul class="am-nav am-nav-pills am-topbar-nav" style="font-size:15px">
      ...
      <li class="am-active"><a href="lw-article-fullwidth.php">唢呐名家</a></li>
	...
	//若有，输出结果
		...
		foreach ($result as $one){   ?>
			<tr>
				...
				<td><?php 
				if (isset($one['image'])){ echo getfield($one['image']);}
				else {echo "--";}
				?></td>
				<td><a href="http://118.24.29.39:8983/solr/snmeta/select?q=person:id=<?php echo getfield($one['id']);?>>
                <?php echo getfield($one['person_name']);?></a></td>   
